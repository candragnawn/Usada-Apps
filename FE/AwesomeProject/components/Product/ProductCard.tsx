...
const getImageUrl = (imagePath: string | string[]): string => {
  if (!imagePath) {
    return `${IMAGE_BASE_URL}default-product.jpg`;
  }
  ...
  let finalUrl = imageString;

  // If already full URL (starts with http)
  ...
  // This uses the custom Laravel route created to bypass stream errors.
  if (finalUrl.includes("/storage/products/")) {
    finalUrl = finalUrl.replace("/storage/products/", "/media/");
  } else if (finalUrl.includes("/storage/")) {
    finalUrl = finalUrl.replace("/storage/", "/media/");
  }

  // Debug log for troubleshooting
  if (__DEV__) {
    console.log("🖼️  [ImageURL] Input:", imagePath, "-> Output:", finalUrl);
  }
...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  // Get first image from array, with proper fallback
  const productImage =
        ...
        <View style={styles.listContainer}>
          ...
          <View style={styles.listImageContainer}>
            <Image
              source={{
                uri: imageError
                  ? `${IMAGE_BASE_URL}default-product.jpg`
                  : imageUrl,
              }}
  ...
  return (
    ...
    >
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{
            uri: imageError ? `${IMAGE_BASE_URL}default-product.jpg` : imageUrl,
          }}
