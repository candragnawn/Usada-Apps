...
<div class="py-6 px-4 md:px-8 dark:bg-[#D5CBB8] min-h-screen">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-14 w-14">
                                            @if(!empty($product->images) && is_array($product->images) && count($product->images) > 0)
                                                <img class="h-[50px] w-[50px] rounded-md object-cover" 
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-10 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="{{ route('products.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                            </svg>
                                            Add New Product
            ...
            @if($products->count() > 0 && method_exists($products, 'links'))
