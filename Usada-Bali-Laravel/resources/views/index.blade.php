              ...
              <div class="mt-5 flex items-end justify-between">
                <div>
                  ...
                  <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                    {{ number_format($total_customers,2) }}
                </h4>
                </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
            <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div class="flex items-center gap-3">
                <button class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-[#FEA35E] dark:hover:bg-white/[0.03] dark:hover:text-[#ffffff]">
                  Filter
                </button>
                        ...
                        <div class="flex items-center">
                          <div class="flex items-center gap-3">
                            <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                              <img src="{{ $best_seller->productVariant->product->image_url }}" alt="Product" />
                            </div>
                            <div>
                      ...
                      <td class="py-3">
                        <div class="flex items-center">
                          <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                            {{ $best_seller->productVariant->product->category->name ?? 'N/A' }}
                          </p>
                        </div>
                      </td>
                      <td class="py-3">
                        <div class="flex items-center">
                          <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                            ${{ number_format($best_seller->productVariant->product->price, 2) }}
                          </p>
                        </div>
                      </td>
                      <td class="py-3">
